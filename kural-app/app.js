...
const STR = {
  ta: {
    ...
    malai: 'திருவள்ளுவமாலை', malaiSub: 'திருக்குறளையும் திருவள்ளுவரையும் போற்றும் 55 வாழ்த்துப் பாடல்கள் — ஔவையார், கபிலர், பரணர், நக்கீரர், இடைக்காடர் உள்ளிட்ட 53 புலவர்களின் பெயரால்', malaiToday: 'இன்றைய வாழ்த்துப் பாடல்', malaiPoet: 'புலவர்', malaiGloss: 'கருத்துரை', malaiAll: 'எல்லாப் பாடல்களும்', malaiFrom: 'திருவள்ளுவமாலையிலிருந்து', malaiVerse: 'பாடல்', malaiNote: 'சங்கப் புலவர்கள் பாடியதாக மரபு கூறும் தொகுப்பு; ஆசிரியர்களும் காலமும் ஆய்வாளர்களிடையே விவாதத்திற்குரியவை. 53 வெண்பாக்களும் 2 குறட்பாக்களும்.', malaiDraft: 'கருத்துரை: AI-உதவியுடன் உருவாக்கிய வரைவு — CICT அறிஞர் சரிபார்ப்புக்குரியது; பிழை கண்டால் ⚑ வழியாகத் தெரிவிக்கலாம்.', malaiSource: 'மூலம்: பொதுக்களப் பதிப்புகள் (Project Madurai · விக்கிமூலம்), இரண்டையும் ஒப்பிட்டு. பாடல்கள் 1–20 சந்தி சேர்ந்த பழைய எழுத்துமுறையிலும், 21–55 சொற்பிரிப்பு முறையிலும் மூலத்தில் உள்ளவாறே.',
  ...
  hi: {
    ...
    malaiDraft: "अर्थ: AI-सहायता से तैयार प्रारूप, CICT विद्वानों की समीक्षा प्रतीक्षित; त्रुटि हो तो ⚑ से सूचित करें।",
...
function malaiCard(v, opts = {}) {
  ...
  return `<div class="card malai-card" data-n="${v.n}">
    ...
    ${gloss && !opts.brief ? `<div class="malai-gloss">${esc(gloss)}</div>` : ''}
...
async function viewMalai(n) {
  ...
  render(`<div class="nav-pn pn-top">${n > 1 ? `<a class="btn" href="#/malai/${n - 1}">${t('prev')}</a>` : '<span></span>'}<a class="btn" href="#/malai">☰ ${t('malaiAll')}</a>${n < vs.length ? `<a class="btn" href="#/malai/${n + 1}">${t('next')}</a>` : ''}</div>` +
    ...
    `<div class="ai-note" style="margin:0 4px">${t('malaiDraft')}</div>`);
  wireMalai(vs);
}
